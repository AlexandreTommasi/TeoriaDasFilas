...
export const Priority1: React.FC = () => {
  const [inputs, setInputs] = useState<Omit<PrioritySemInput, 's'> & { mu: number | string; lambdas: (number | string)[] }>({
    mu: '',
    lambdas: ['', ''],
  });
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        <h2 className="text-4xl font-display font-bold text-dark-950 mb-2">
          M/M/1 com Prioridade (Sem Interrupção)
        </h2>
        <p className="text-dark-600 text-lg">
          Múltiplas Filas • <strong>1 Servidor</strong> • Prioridade Não-Preemptiva
        </p>
      </div>
          ...
          <div>
            ...
            <div className="text-purple-900">
              ...
              <div className="mt-2 bg-blue-100 border border-blue-400 p-2 rounded text-sm">
                <strong>ℹ️ Para 2 ou mais servidores (s≥2):</strong> Use o modelo <strong>Priority2</strong>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-wine-500 to-wine-700 rounded-2xl shadow-2xl p-1 mb-6">
        <div className="bg-white rounded-xl p-6">
          <h3 className="font-display font-bold text-wine-900 text-2xl mb-1">
            🧮 Calculadora M/M/1 com Prioridade (s = 1)
          </h3>
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-2 border-indigo-400 rounded-xl p-5 shadow-lg">
        <h4 className="font-bold text-indigo-900 text-xl mb-4">📐 Fórmulas do Modelo (M/M/1, s=1)</h4>
        <div className="bg-white rounded-lg p-5 space-y-3 text-sm">
          ...
          <div className="border-b pb-2 bg-yellow-50 p-2 rounded">
            <p className="font-mono text-indigo-900"><strong>A = μ / (1 - ρ)</strong></p>
            <p className="text-xs text-gray-600">⭐ Termo constante A simplificado para s=1</p>
          </div>
          <div className="border-b pb-2">
