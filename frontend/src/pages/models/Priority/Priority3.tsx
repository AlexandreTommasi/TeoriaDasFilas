...
// import { calculatePriority3 } from '../../../services/api'; // Descomentar quando backend estiver pronto
...
export const Priority3: React.FC = () => {
  ...
  const handleCalculate = async (e: React.FormEvent) => {
    ...
    // try {
    //   const result = await calculatePriority3(inputs);
    //   setResults(result);
    // } catch (err) {
  ...
  return (
    <div className="max-w-4xl">
      <h2 className="text-3xl font-bold text-gray-800 mb-4">
        Modelo com Prioridades - Variação 3
      </h2>
      <p className="text-gray-600 mb-6">
        Sistema de filas com diferentes níveis de prioridade - Modelo 3.
      </p>
      ...
      <div className="mt-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
        ...
        <ul className="list-disc list-inside text-blue-700 text-sm mt-1 ml-2">
          <li>Implemente as fórmulas do Modelo Prioridade 3 no backend Python (pasta /backend)</li>
          <li>Arquivo: backend/app/models/priority.py (função calculate_priority3)</li>
          <li>Defina os inputs necessários em types/models.ts</li>
          <li>Crie o endpoint POST /api/calculate/priority3</li>
