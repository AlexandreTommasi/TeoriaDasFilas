...
export const MMsN: React.FC = () => {
    ...
    ? [
        {
          ...
          value: results.rho,
          description: 'N×λ/(s×μ) - Intensidade do tráfego',
        },
        {
          ...
          ? [
              {
                ...
                description: 'Probabilidade de não esperar na fila',
              },
            ]
          : []),
      ]
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Cabeçalho */}
      <div className="mb-6">
        <h2 className="text-4xl font-display font-bold text-dark-950 mb-2">Modelo M/M/s&gt;1/N</h2>
        <p className="text-dark-600 text-lg">
          1 Fila • Múltiplos Servidores (s≥2) • População Finita (N clientes)
        </p>
      </div>
          ...
          <form onSubmit={handleCalculate} className="space-y-5">
            ...
            <div className="bg-gray-50 rounded-lg p-5 border-2 border-gray-200">
              ...
              <div className="mt-3 bg-yellow-50 border border-yellow-300 p-3 rounded text-sm">
                ...
                <p className="mt-1">• s servidores trabalhando em paralelo (capacidade = s×μ)</p>
                <p className="mt-1">• <strong>Taxa total de chegadas:</strong> λ_efetivo = λ × (N - L)</p>
                <p className="mt-1 text-red-700"><strong>⚠️ NÃO precisa λ &lt; s×μ!</strong> Sistema sempre estável com N finito</p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-400 rounded-xl p-5 shadow-lg">
          <h4 className="font-bold text-purple-900 text-lg mb-3">📝 Exemplo 1: 10 Máquinas com 2 Técnicos</h4>
          <div className="space-y-2 text-sm text-purple-900">
            <div className="bg-white p-3 rounded">
              <p className="font-semibold mb-1">Situação:</p>
              <p>10 máquinas que quebram e precisam de 2 técnicos para reparo</p>
            </div>
            <div className="bg-white p-3 rounded">
              <p className="font-semibold mb-1">Dados:</p>
              <p>• N = <strong>10 máquinas</strong></p>
              <p>• s = <strong>2 técnicos</strong></p>
              <p>• Tempo até quebra = 60 min → λ = <strong>1/60 máq/min</strong></p>
              <p>• Tempo reparo = 8 min → μ = <strong>1/8 máq/min</strong></p>
            </div>
            <div className="bg-white p-3 rounded">
              <p className="font-semibold mb-1">Interpretação:</p>
              <p>• Cada máquina quebra a 1/60 por min quando operando</p>
              <p>• Total quebras/min = λ(N-L) = (1/60)×(10-L)</p>
              <p>• Capacidade total = 2 × (1/8) = 0,25 máq/min</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-400 rounded-xl p-5 shadow-lg">
          <h4 className="font-bold text-green-900 text-lg mb-3">📝 Exemplo 2: 5 Robôs com 2 Técnicos</h4>
          <div className="space-y-2 text-sm text-green-900">
            <div className="bg-white p-3 rounded">
              <p className="font-semibold mb-1">Dados:</p>
              <p>• N = <strong>5 robôs</strong></p>
              <p>• s = <strong>2 técnicos</strong></p>
              <p>• Tempo operação = 2h = 120 min → λ = <strong>1/120 rob/min</strong></p>
              <p>• Tempo manutenção = 30 min → μ = <strong>1/30 rob/min</strong></p>
            </div>
            <div className="bg-white p-3 rounded">
              ...
              <p>• c) Taxa efetiva = <strong>λ(N-L)</strong></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-400 rounded-xl p-6 shadow-lg mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-orange-900 mb-2">c) % tempo ocioso dos técnicos?</p>
          ...
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-orange-900 mb-2">i) Prob. de não esperar na fila?</p>
            <p className="text-gray-700">→ Resposta: <strong>P(Wq=0)</strong></p>
          </div>
          <div className="bg-white p-4 rounded-lg">
            <p className="font-semibold text-orange-900 mb-2">j) Capacidade total de atendimento?</p>
            <p className="text-gray-700">→ Resposta: <strong>s × μ</strong></p>
          </div>
        </div>
      </div>

      {/* Diferenças M/M/1/N vs M/M/s/N */}
      <div className="bg-gradient-to-r from-indigo-50 to-indigo-100 border-2 border-indigo-400 rounded-xl p-5 shadow-lg mb-6">
        <h3 className="font-bold text-indigo-900 text-xl mb-3">🔄 M/M/1/N vs M/M/s/N - Qual usar?</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="bg-white p-4 rounded-lg border-2 border-indigo-300">
            <h4 className="font-bold text-indigo-900 mb-2">Use M/M/1/N se:</h4>
            <ul className="space-y-1 text-indigo-800">
              <li>✓ <strong>1 SERVIDOR</strong> (s=1)</li>
              <li>✓ População finita (N clientes)</li>
              <li>✓ Taxa VARIÁVEL: λ(N-L)</li>
              <li>✓ NÃO precisa λ &lt; μ (sempre estável)</li>
            </ul>
          </div>
          <div className="bg-white p-4 rounded-lg border-2 border-purple-300">
            <h4 className="font-bold text-purple-900 mb-2">Use M/M/s/N se:</h4>
            <ul className="space-y-1 text-purple-800">
              <li>✓ <strong>MÚLTIPLOS SERVIDORES</strong> (s≥2)</li>
              <li>✓ População finita (N clientes)</li>
              <li>✓ Taxa VARIÁVEL: λ(N-L)</li>
              <li>✓ NÃO precisa λ &lt; s×μ (sempre estável)</li>
            </ul>
          </div>
        </div>
        <div className="mt-4 bg-indigo-200 p-3 rounded">
          <p className="text-indigo-900 text-sm">
            <strong>🔑 Dica chave:</strong> Se o exercício fala "10 máquinas com 2 técnicos", "5 robôs com 2 operadores"
            → População finita + múltiplos servidores → use <strong>M/M/s/N</strong>!
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-red-50 to-red-100 border-2 border-red-400 rounded-xl p-5 shadow-lg mb-6">
        <h3 className="font-bold text-red-900 text-xl mb-3">⚠️ Conceitos Importantes do M/M/s/N</h3>
        <div className="space-y-3 text-sm text-red-900">
          <div className="bg-white p-3 rounded">
            <p className="font-semibold mb-1">🔄 Ciclo dos Clientes:</p>
            <p>Operando → Quebra (chegada) → Fila → Reparo (s servidores) → Operando novamente</p>
          </div>
          <div className="bg-white p-3 rounded">
          ...
          <div className="bg-white p-3 rounded">
            ...
            <p>Não precisa λ &lt; s×μ! População finita garante estabilidade</p>
          </div>
          <div className="bg-white p-3 rounded">
            <p className="font-semibold mb-1">👥 Múltiplos Servidores:</p>
            <p>Capacidade total = s × μ (vários técnicos trabalhando em paralelo)</p>
          </div>
          <div className="bg-white p-3 rounded">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-2 border-yellow-400 rounded-xl p-5 shadow-lg mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-yellow-900">
          <div className="bg-white p-4 rounded">
            ...
            <p>• Tempo = 60 minutos</p>
            <p>• λ = 1/60 quebras/min ✓</p>
          </div>
          <div className="bg-white p-4 rounded">
            <p className="font-semibold mb-2">Se te dão TEMPO de reparo:</p>
            <p>• Tempo = 8 minutos</p>
            <p>• μ = 1/8 reparos/min ✓</p>
          </div>
          <div className="bg-white p-4 rounded">
            <p className="font-semibold mb-2">Capacidade total:</p>
            <p>• s=2 técnicos, μ=0,125 cada</p>
            <p>• Capacidade = 2×0,125 = 0,25 ✓</p>
          </div>
          <div className="bg-white p-4 rounded">
