    ...
    <div className="max-w-4xl">
      ...
      <div className="mt-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
        ...
        <ul className="list-disc list-inside text-blue-700 text-sm mt-1 ml-2">
          <li>Implemente as fórmulas do M/M/1/N no backend Python (pasta /backend)</li>
          <li>Arquivo: backend/app/models/mm1n.py</li>
          <li>Crie o endpoint POST /api/calculate/mm1n</li>
